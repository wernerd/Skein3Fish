...
//                + "3B4C382CE37AA192A4019E763036F4F5DD4D7EBB"));
    ...
    static final Hashtable<String, DERObjectIdentifier> objIds = new Hashtable<String, DERObjectIdentifier>();
    static final Hashtable<DERObjectIdentifier, X9ECParametersHolder> curves = new Hashtable<DERObjectIdentifier, X9ECParametersHolder>();
    static final Hashtable<DERObjectIdentifier, String> names = new Hashtable<DERObjectIdentifier, String>();
    ...
    public static X9ECParameters getByName(
        String name)
    {
        DERObjectIdentifier oid = objIds.get(Strings.toLowerCase(name));
    ...
    {
        X9ECParametersHolder holder = curves.get(oid);
